 ...
 *
 * @author ljh
 * @className CooperativeAppointmentBO
 * @time 2023-01-09 02:56:41
 */
@Data
@ApiModel(value = "云服合作预约传输")
public class CooperativeAppointmentBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {CooperativeAppointmentBO.Update.class, CooperativeAppointmentBO.Remove.class}, message = "id不能为空")
    private String id;
    ...
    @ApiModelProperty(name = "operator", value = "操作人姓名")
    ...
    @TableField(exist = false)
    @ApiModelProperty(name = "logDescription", value = "日志备注")
