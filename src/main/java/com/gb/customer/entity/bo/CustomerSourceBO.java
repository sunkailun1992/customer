 ...
 *
 * @author lijh
 * @className CustomerSourceBO
 * @time 2022-09-01 03:12:09
 */
@Data
@ApiModel(value = "客户来源传输")
public class CustomerSourceBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {CustomerSourceBO.Update.class, CustomerSourceBO.Remove.class}, message = "id不能为空")
    private String id;
