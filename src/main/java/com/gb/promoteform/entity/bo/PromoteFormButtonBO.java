 ...
 *
 * @author lijh
 * @className PromoteFormButtonBO
 * @time 2022-07-04 10:49:04
 */
@Data
@ApiModel(value = "推广表单按钮传输")
public class PromoteFormButtonBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {PromoteFormButtonBO.Update.class, PromoteFormButtonBO.Remove.class}, message = "id不能为空")
    private String id;
