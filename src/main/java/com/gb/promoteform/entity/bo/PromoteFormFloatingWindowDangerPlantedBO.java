 ...
 *
 * @author lijh
 * @className PromoteFormFloatingWindowDangerPlantedBO
 * @time 2022-07-04 10:49:04
 */
@Data
@ApiModel(value = "推广表单浮框险种传输")
public class PromoteFormFloatingWindowDangerPlantedBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {PromoteFormFloatingWindowDangerPlantedBO.Update.class, PromoteFormFloatingWindowDangerPlantedBO.Remove.class}, message = "id不能为空")
    private String id;
