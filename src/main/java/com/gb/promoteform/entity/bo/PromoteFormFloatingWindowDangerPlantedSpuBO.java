 ...
 *
 * @author lijh
 * @className PromoteFormFloatingWindowDangerPlantedSpuBO
 * @time 2022-10-28 03:09:31
 */
@Data
@ApiModel(value = "推广表单浮框险种产品传输")
public class PromoteFormFloatingWindowDangerPlantedSpuBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {PromoteFormFloatingWindowDangerPlantedSpuBO.Update.class, PromoteFormFloatingWindowDangerPlantedSpuBO.Remove.class}, message = "id不能为空")
    private String id;
