 ...
 *
 * @author lijh
 * @className PromoteFormProductSpuBO
 * @time 2022-10-28 03:09:32
 */
@Data
@ApiModel(value = "推广表单产品id传输")
public class PromoteFormProductSpuBO implements Serializable {

    @ApiModelProperty(value = "序列")
    @NotBlank(groups = {PromoteFormProductSpuBO.Update.class, PromoteFormProductSpuBO.Remove.class}, message = "id不能为空")
    private String id;
