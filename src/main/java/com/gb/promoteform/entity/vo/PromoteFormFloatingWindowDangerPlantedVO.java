 ...
 *
 * @author lijh
 * @className PromoteFormFloatingWindowDangerPlantedVO
 * @time 2022-07-04 10:49:04
 */
@Data
@ApiModel(value = "推广表单浮框险种渲染")
public class PromoteFormFloatingWindowDangerPlantedVO implements Serializable {
